...
axios.get(`https://maps.googleapis.com/maps/api/geocode/json?address=${encodedAddress}&key=${apiKey}`).then((response) => {
    if (response.data.status === 'ZERO_RESULTS') {
        ...
        // TODO: TAREA: devolver otra promesa llamando a la funcion axios.get
        // La peticion va para RapidAPI
        // Obtener el weather para la address
        // redactar la logica para cuando se complete esta segunda promesa.
    }
}, (error) => {
    console.log(error);
});
